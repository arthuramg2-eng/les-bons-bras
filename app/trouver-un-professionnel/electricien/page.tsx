  ...
  const electriciens = [
    {
      ...
      note: 4.8,
      avis: 134,
      image: "/images/electricien1.jpg",
      disponible: true,
      specialites: ["Installation", "Résidentiel"],
      tarif: "65€/h",
      verified: true,
      testimonial: "Très professionnel, installation impeccable et propre."
    },
    {
      id: 2,
      nom: "Volt & Lumière",
      ...
      note: 4.9,
      avis: 156,
      image: "/images/electricien2.jpg",
      disponible: true,
      specialites: ["Domotique", "Éclairage intelligent"],
      tarif: "75€/h",
      verified: true,
      testimonial: "Expert en domotique, notre maison est maintenant connectée."
    },
    {
      id: 3,
      ...
      note: 4.7,
      avis: 189,
      image: "/images/electricien3.jpg",
      disponible: false,
      specialites: ["Dépannage urgent", "24/7"],
      tarif: "70€/h",
      verified: true,
      testimonial: "Intervention rapide en urgence, très réactif."
    },
  ];
    ...
    <div className="min-h-screen bg-[#F8F7F4]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center max-w-3xl mx-auto mb-10">
            ...
            <h1 className="text-4xl md:text-5xl font-light text-[#111] mb-4 tracking-tight">
              Trouvez un électricien de confiance
            </h1>
            <p className="text-lg text-[#666] font-light leading-relaxed">
              Des professionnels qualifiés, notés par des clients réels.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white border-2 border-gray-200 rounded-full shadow-lg hover:shadow-xl transition-shadow p-2 flex flex-col md:flex-row gap-2">
              ...
              <div className="flex-1 px-6 py-3">
                <label className="text-xs font-medium text-[#111] block mb-1">Type de travaux</label>
                <input 
                  type="text" 
                  placeholder="Installation, dépannage..." 
                  className="w-full text-sm text-[#666] outline-none font-light"
                />
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-6 text-sm text-[#666] font-light">
          {electriciens.length} électriciens disponibles
        </div>

        {/* CARDS GRID */}
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {electriciens.map((elec, index) => (
            <div
              key={elec.id}
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="mb-3">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <div className="flex items-center gap-1 bg-[#F8F7F4] px-2.5 py-1 rounded-lg">
                      ...
                      <span className="text-sm font-medium text-[#111]">{elec.note}</span>
                      <span className="text-xs text-[#666]">({elec.avis})</span>
                    </div>
                  </div>
                  
                  {/* Specialités */}
                  <div className="flex gap-2 mb-3">
                    {elec.specialites.map((spec, i) => (
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-sm text-[#111] font-medium">À partir de {elec.tarif}</span>
                  </div>
                </div>
