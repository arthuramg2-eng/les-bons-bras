...
export default function EntrepreneurGeneralPage() {
  const [activeFilter, setActiveFilter] = useState<string | null>(null);

  const entrepreneurs = [
    {
      id: 1,
      nom: "Bâtisseurs Experts",
      description: "Gestion complète de projets de rénovation et construction",
      experience: "20 ans",
      ville: "Paris",
      note: 4.9,
      avis: 178,
      ...
      disponible: true,
      specialites: ["Rénovation complète", "Gestion de projet"],
      tarif: "Sur devis",
      verified: true,
      testimonial: "Gestion impeccable de notre rénovation complète, dans les délais."
    },
    {
      id: 2,
      nom: "Pro Construction",
      description: "Spécialiste en extension et agrandissement de maisons",
      experience: "15 ans",
      ville: "Lyon",
      note: 4.8,
      avis: 142,
      ...
      disponible: true,
      specialites: ["Extension", "Agrandissement"],
      tarif: "Sur devis",
      verified: true,
      testimonial: "Extension de maison parfaite, équipe très professionnelle."
    },
    {
      id: 3,
      nom: "Rénovation Premium",
      description: "Projets haut de gamme et coordination multi-corps de métier",
      experience: "25 ans",
      ville: "Bordeaux",
      note: 4.9,
      avis: 201,
      ...
      disponible: false,
      specialites: ["Haut de gamme", "Multi-corps"],
      tarif: "Sur devis",
      verified: true,
      testimonial: "Coordination parfaite, résultat exceptionnel pour notre loft."
    },
  ];
  ...
  const filters = [
    ...
    { id: "renovation", label: "Rénovation complète", icon: "🏗️" },
    ...
    <div className="min-h-screen bg-[#F8F7F4]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center max-w-3xl mx-auto mb-10">
            ...
            <h1 className="text-4xl md:text-5xl font-light text-[#111] mb-4 tracking-tight">
              Trouvez un entrepreneur général de confiance
            </h1>
            <p className="text-lg text-[#666] font-light leading-relaxed">
              Des gestionnaires de projet expérimentés, notés par des clients réels.
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-6 text-sm text-[#666] font-light">
          {entrepreneurs.length} entrepreneurs disponibles
        </div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="mb-3">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <div className="flex items-center gap-1 bg-[#F8F7F4] px-2.5 py-1 rounded-lg">
                      ...
                      <span className="text-sm font-medium text-[#111]">{entrepreneur.note}</span>
                      <span className="text-xs text-[#666]">({entrepreneur.avis})</span>
                    </div>
                  </div>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-sm text-[#111] font-medium">{entrepreneur.tarif}</span>
                  </div>
                </div>
