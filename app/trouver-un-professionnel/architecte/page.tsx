...
export default function ArchitectePage() {
  ...
  const architectes = [
    {
      ...
      note: 4.9,
      avis: 127,
      image: "/images/architecte1.jpg",
      disponible: true,
      specialites: ["Rénovation", "Design contemporain"],
      tarif: "120€/h",
      verified: true,
      testimonial: "Travail remarquable, très à l'écoute de nos besoins."
    },
    {
      id: 2,
      nom: "Studio Créatif",
      ...
      note: 4.8,
      avis: 94,
      image: "/images/architecte2.jpg",
      disponible: true,
      specialites: ["Résidentiel", "Espaces sur mesure"],
      tarif: "95€/h",
      verified: true,
      testimonial: "Créativité exceptionnelle et respect des délais."
    },
    {
      id: 3,
      ...
      note: 4.9,
      avis: 156,
      image: "/images/architecte3.jpg",
      disponible: false,
      specialites: ["Patrimoine", "Extension"],
      tarif: "150€/h",
      verified: true,
      testimonial: "Expertise incomparable sur les bâtiments anciens."
    },
  ];
  ...
  const filters = [
    ...
    { id: "contemporary", label: "Design contemporain", icon: "✨" },
  ];
    ...
    <div className="min-h-screen bg-[#F8F7F4]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center max-w-3xl mx-auto mb-10">
            ...
            <h1 className="text-4xl md:text-5xl font-light text-[#111] mb-4 tracking-tight">
              Trouvez un architecte de confiance
            </h1>
            <p className="text-lg text-[#666] font-light leading-relaxed">
              Des professionnels vérifiés, notés par des clients réels.
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-6 text-sm text-[#666] font-light">
          {architectes.length} architectes disponibles
        </div>

        {/* CARDS GRID */}
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {architectes.map((arch, index) => (
            <div
              key={arch.id}
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="mb-3">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <div className="flex items-center gap-1 bg-[#F8F7F4] px-2.5 py-1 rounded-lg">
                      ...
                      <span className="text-sm font-medium text-[#111]">{arch.note}</span>
                      <span className="text-xs text-[#666]">({arch.avis})</span>
                    </div>
                  </div>
                  
                  {/* Specialités */}
                  <div className="flex gap-2 mb-3">
                    {arch.specialites.map((spec, i) => (
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-sm text-[#111] font-medium">À partir de {arch.tarif}</span>
                  </div>
                </div>
