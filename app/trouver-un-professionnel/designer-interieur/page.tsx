...
export default function DesignerInterieurPage() {
  ...
  const designers = [
    {
      ...
      disponible: true,
      specialites: ["Résidentiel", "Sur mesure"],
      tarif: "85€/h",
      verified: true,
      testimonial: "Créativité exceptionnelle et sens du détail remarquable."
    },
    {
      id: 2,
      ...
      disponible: true,
      specialites: ["Moderne", "Rénovation"],
      tarif: "75€/h",
      verified: true,
      testimonial: "Design moderne et fonctionnel, exactement ce qu'on cherchait."
    },
    {
      id: 3,
      ...
      disponible: false,
      specialites: ["Haut de gamme", "Décoration"],
      tarif: "110€/h",
      verified: true,
      testimonial: "Transformation complète de notre appartement, résultat bluffant."
    },
  ];
  ...
  const filters = [
    ...
    { id: "residential", label: "Résidentiel", icon: "🏠" },
  ];
    ...
    <div className="min-h-screen bg-[#F8F7F4]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center max-w-3xl mx-auto mb-10">
            ...
            <h1 className="text-4xl md:text-5xl font-light text-[#111] mb-4 tracking-tight">
              Trouvez un designer d'intérieur de confiance
            </h1>
            <p className="text-lg text-[#666] font-light leading-relaxed">
              Des professionnels créatifs, notés par des clients réels.
            </p>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-6 text-sm text-[#666] font-light">
          {designers.length} designers disponibles
        </div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="mb-3">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <div className="flex items-center gap-1 bg-[#F8F7F4] px-2.5 py-1 rounded-lg">
                      ...
                      <span className="text-sm font-medium text-[#111]">{designer.note}</span>
                      <span className="text-xs text-[#666]">({designer.avis})</span>
                    </div>
                  </div>
                  
                  {/* Specialités */}
                  <div className="flex gap-2 mb-3">
                    {designer.specialites.map((spec, i) => (
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-sm text-[#111] font-medium">À partir de {designer.tarif}</span>
                  </div>
                </div>
