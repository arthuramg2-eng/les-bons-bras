...
export default function PaysagistePage() {
  ...
  const paysagistes = [
    {
      id: 1,
      nom: "Jardins Créatifs",
      description: "Conception et aménagement de jardins contemporains",
      experience: "14 ans",
      ville: "Paris",
      note: 4.9,
      avis: 124,
      image: "/images/paysagiste1.jpg",
      disponible: true,
      specialites: ["Jardins contemporains", "Aménagement"],
      tarif: "80€/h",
      verified: true,
      testimonial: "Jardin magnifique, vision créative et excellente écoute."
    },
    {
      id: 2,
      nom: "Espaces Verts Pro",
      description: "Spécialiste en entretien et rénovation de jardins",
      experience: "11 ans",
      ville: "Lyon",
      note: 4.8,
      avis: 107,
      image: "/images/paysagiste2.jpg",
      disponible: true,
      specialites: ["Entretien", "Rénovation"],
      tarif: "65€/h",
      verified: true,
      testimonial: "Service d'entretien impeccable, jardin toujours parfait."
    },
    {
      id: 3,
      nom: "Naturea Design",
      description: "Paysagisme écologique et jardins durables",
      experience: "18 ans",
      ville: "Bordeaux",
      note: 4.9,
      avis: 156,
      image: "/images/paysagiste3.jpg",
      disponible: false,
      specialites: ["Écologique", "Durable"],
      tarif: "90€/h",
      verified: true,
      testimonial: "Approche écologique parfaite, jardin en harmonie avec la nature."
    },
  ];
  ...
  const filters = [
    ...
    { id: "contemporary", label: "Jardins contemporains", icon: "🌿" },
    { id: "ecological", label: "Écologique", icon: "♻️" },
  ];
    ...
    <div className="min-h-screen bg-[#F8F7F4]">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center max-w-3xl mx-auto mb-10">
            ...
            <h1 className="text-4xl md:text-5xl font-light text-[#111] mb-4 tracking-tight">
              Trouvez un paysagiste de confiance
            </h1>
            <p className="text-lg text-[#666] font-light leading-relaxed">
              Des créateurs d'espaces verts passionnés, notés par des clients réels.
            </p>
          </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-white border-2 border-gray-200 rounded-full shadow-lg hover:shadow-xl transition-shadow p-2 flex flex-col md:flex-row gap-2">
              ...
              <div className="flex-1 px-6 py-3">
                <label className="text-xs font-medium text-[#111] block mb-1">Type de projet</label>
                <input 
                  type="text" 
                  placeholder="Création, entretien..." 
                  className="w-full text-sm text-[#666] outline-none font-light"
                />
              </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-6 text-sm text-[#666] font-light">
          {paysagistes.length} paysagistes disponibles
        </div>

        {/* CARDS GRID */}
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 mb-16">
          {paysagistes.map((paysagiste, index) => (
            <div
              key={paysagiste.id}
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="mb-3">
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <div className="flex items-center gap-1 bg-[#F8F7F4] px-2.5 py-1 rounded-lg">
                      ...
                      <span className="text-sm font-medium text-[#111]">{paysagiste.note}</span>
                      <span className="text-xs text-[#666]">({paysagiste.avis})</span>
                    </div>
                  </div>
                  
                  {/* Specialités */}
                  <div className="flex gap-2 mb-3">
                    {paysagiste.specialites.map((spec, i) => (
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <span className="text-sm text-[#111] font-medium">À partir de {paysagiste.tarif}</span>
                  </div>
                </div>
